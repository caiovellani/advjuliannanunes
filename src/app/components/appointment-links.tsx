  ...
  return (
    <div className="pt-8 flex flex-col gap-4 justify-between">
      <Link
        ...
        className="w-[350px] border border-[#aa895d] bg-amber-50/80 text-black rounded-xl p-3 flex justify-between items-center hover:bg-zinc-50"
      >
        Agendar atendimento
      ...
      <Link
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-[350px] bg-amber-50/80 text-black rounded-xl border border-[#aa895d] p-3 flex justify-between items-center hover:bg-zinc-50"
      >
        Quero me aposentar
        <Export className="size-6" />
      </Link>
